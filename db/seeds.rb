...
Trip.create(description: 'NYFA and dodging cars for money.', start_on: Date.parse('2007-01-01'), end_on: Date.parse('2012-06-15'), user: u2, location: l2)
Trip.create(description: 'Digital nomad life begins.', start_on: Date.parse('2022-11-01'), end_on: Date.parse('2099-01-01'), user: u3, location: l3)
